...
def TriangleNet_NoContour_Train():
    NAME = 'TriangleNet_NoContour'

    # run the Visdom
    viz = Visualizer(env=NAME)

    solver = MyFrame(TriangleNet_NoContour, dice_bce_loss, 2e-4)
    ...
    dataset = ImageFolder(root_path=Constants.ROOT, datasets='content')
